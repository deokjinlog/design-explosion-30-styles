...
**진행 상태**: 서체·스케일·틴트·팔레트 재접지 = **완료**. 원형 D 구조 signature = **13/30 완료** — 04·09·10·18·19(터미널·픽셀·에디토리얼·스위스·맥시멀) + 위 표의 05·16·21·22·23·24·29·30(Neubrutal·Material 3·Riso·De Stijl·Carbon·Bauhaus·Memphis·Ant). 나머지 17종은 토큰전용(서체·팔레트·스케일로 차별). 원형 A·B용 구조 signature 확장은 후속.
