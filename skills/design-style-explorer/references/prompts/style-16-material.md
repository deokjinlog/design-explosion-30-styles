...
> ⚠️ **정체성 갱신(2026-07-26)**: 이 스타일은 산업 라벨 "머티리얼"에서 출처 있는 디자인 언어 **"Material 3 (정본)"** 로 재접지됐습니다. **정본 정의**는 `tokens/style-16.css` + `signature/style-16--D.css` + [`docs/design/2026-07-26-type-and-source-grounding.md`](../../../../docs/design/2026-07-26-type-and-source-grounding.md) 를 따르세요. 아래 본문(구 산업 라벨 v2 스펙)은 참조용 — full 재작성은 후속.
