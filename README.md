...
**MIT** · 의존성 없음. 자세한 내용은 [LICENSE](LICENSE).

버그 제보 · 제안 · 새 스타일 기여는 [GitHub Issues](https://github.com/deokjinlog/design-explosion-30-styles/issues) 로 받습니다.
새 스타일을 더하려면 `skills/design-style-explorer/references/prompts/` 에 전용 프롬프트를,
`skills/design-style-explorer/scripts/style-lint.py` 에 금지 규칙을 함께 넣어주세요.
